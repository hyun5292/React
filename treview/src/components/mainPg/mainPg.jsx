...
const MainPg = ({}) => {
  return (
    <div className={`${styles.mainPg} ${pgStyle.pg} ${pgStyle.pgPadding}`}>
      ...
      <div className={`${styles.introCont} ${styles.intro1}`}>
        <p>
          트리뷰(Treview)란? 트럭(Truck) + 리뷰(Review)의 줄임말로
          <br />
      ...
      <div className={`${styles.introCont} ${styles.intro2}`}>
        <p>
          트리뷰(Treview)란? 트럭(Truck) + 리뷰(Review)의 줄임말로
          <br />
          경기도 내 일반 화물업체(이사화물이 아닌 화물)의 운송을 주선하는
      ...
      <div className={`${styles.introCont} ${styles.intro3}`}>
        <p>
          트리뷰(Treview)란? 트럭(Truck) + 리뷰(Review)의 줄임말로
          <br />
          경기도 내 일반 화물업체(이사화물이 아닌 화물)의 운송을 주선하는
