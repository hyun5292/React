        ...
        <div className={styles.icon_wrap}>
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>html</h4>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>css</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>javascript</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>jquery</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>react</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>postcss</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>sass</h4>
              <p className={styles.info_cont}>
      ...
      <div className={`${styles.block} ${styles.back}`}>
        ...
        <div className={styles.icon_wrap}>
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>spring</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>mariadb</h4>
              <p className={styles.info_cont}>
      ...
      <div className={`${styles.block} ${styles.etc}`}>
        ...
        <div className={styles.icon_wrap}>
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>vscode</h4>
              <p className={styles.info_cont}>
          ...
          <div className={styles.icon_item}>
            ...
            <div className={styles.icon_info}>
              <h4 className={styles.info_title}>정보처리기사</h4>
              <p className={styles.info_cont}>
                - 필기
                <br />
                합격 날짜: 2020.06.26
